...
return new class extends Migration
{
    ...
    public function up(): void
    {
      Schema::create('vl_products', function (Blueprint $table) {
          ...
          $table->string('independentstructure');
          $table->string('spaciouslayout');
          $table->string('highceilings');
          $table->string('modernclscaesthtics');
          $table->string('privategardenlawn');
          ...
          $table->string('hvac');
          $table->string('patiodeck');
          $table->string('plumbing');
          $table->string('drvwygrgathtics');
          $table->string('smartsystems');
          $table->string('bndrywllsfencing');
          $table->string('securelcksdoors');
          $table->string('ldscpngYardgdenspce');
          $table->string('fireextinguishers');
          $table->string('sveillancesystms');
          $table->string('solarpanels');
          $table->string('highspeedinternet');
          $table->string('gatedentry');
