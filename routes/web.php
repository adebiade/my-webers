...
Route::post('/wishlist/moveWishlist-to-cart/{rowId}',[WishlistController::class,'moveWishlist_to_cart'])->name('movewishlist.to.cat');
...
//Route::get('/layout-app',[HomeController::class,'search'])->name('home.search');
