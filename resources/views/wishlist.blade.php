      ...
      <div class="shopping-cart">
        ...
        <div class="cart-table__wrapper">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <div class="row">
                      <div class="col-6">
                          <form method="POST" action="{{route('movewishlist.to.cat',['rowId'=>$item->rowId])}}">
                          @csrf
          ...
          <div class="cart-table-footer">
           <form method="POST" action="{{route('wishlist.item.clear')}}">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-light">CLEAR WHISHLIST</button>
           </form>
          </div>
        </div>
        @else
        <div class="row">
          <div class="col-md-12">
                 ...
                 <a href="{{route('shop.index')}}" class= "btn btn-info">Wishlist New</a>
