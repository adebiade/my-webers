      ...
      <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
          ...
          <li>
              <a href="{{route('user.arproduct.add')}}">
                  <div class="text-tiny ">Agent Form</div>
              </a>
          </li>
          <li>
              <i class="icon-chevron-right"></i>
          ...
          <li>
              <div class="text-tiny">Add</div>
          </li>
      </ul>
  </div>
  <!-- form-add-product -->
  <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('user.agentform.store')}}">
    @csrf
      ...
      <div class="wg-box">
        ...
        <fieldset class="name">
            <div class="body-title mb-10">Your mobile Number <span class="tf-color-1">*</span>
            </div>
            <input class="mb-10" type="text" placeholder="Enter your mobile"
                name="mobile" tabindex="0" value="{{old('mobile')}}" aria-required="true" required="">
            <div class="text-tiny">Enter your mobile number</div>
        ...
        <fieldset class="name">
            ...
            <div class="text-tiny">Do not exceed 50 characters.</div>
        ...
        <fieldset class="name">
            ...
            <div class="text-tiny">Your twitter acccount link.</div>
        ...
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" placeholder="Enter your facebook account"
        ...
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" placeholder="Enter your instagram account"
                name="instgrm" tabindex="0" value="{{old('instgrm')}}" aria-required="true" required="">
