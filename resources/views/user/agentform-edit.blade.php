...
<div class="main-content-inner">
  ...
  <!-- form-add-product -->
  <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('user.agentform.update')}}">
    @csrf
    @method('PUT')
     <input type="hidden" name="id" value="{{$agentform->id}}" />
      <div class="wg-box">
        ...
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" placeholder="Enter your name"
                name="name" tabindex="0" value="{{$agentform->name}}" aria-required="true" required="">
        ...
        <fieldset class="name">
            <div class="body-title mb-10">Your working phone number <span class="tf-color-1">*</span>
            </div>
            <input class="mb-10" type="text" placeholder="Enter your mobile"
                name="mobile" tabindex="0" value="{{$agentform->mobile}}" aria-required="true" required="">
            <div class="text-tiny">Enter your working mobile number.</div>
        ...
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" placeholder="Enter product name"
                name="designation" tabindex="0" value="{{$agentform->designation}}" aria-required="true" required="">
        ...
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" placeholder="Enter your twitter account"
                name="twitt" tabindex="0" value="{{$agentform->twitt}}" aria-required="true" required="">
        ...
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" placeholder="Enter your twitter account"
                name="fcbk" tabindex="0" value="{{$agentform->fcbk}}" aria-required="true" required="">
            <div class="text-tiny">Your facebook acccount link.</div>
        ...
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" placeholder="Enter your twitter account"
                name="instgrm" tabindex="0" value="{{$agentform->instgrm}}" aria-required="true" required="">
