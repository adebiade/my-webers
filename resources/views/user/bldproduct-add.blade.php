...
<div class="main-content-inner">
              ...
              <div class="main-content-wrap">
                                ...
                                <!-- form-add-product -->
                                <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('user.bldproduct.store')}}">
                                  @csrf
                                    ...
                                    <div class="wg-box">
                                      @if(Session::has('status'))
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="mb-10" type="text" placeholder="Should be the same with your signup username "
                                ...
                                <img src="images/upload/upload-1.png" alt="">
                                        ...
                                        <div class="cols gap22">
                                            ...
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="phone number" name="mobile" tabindex="0"
