...
<div class="main-content-inner">
    ...
    <div class="text-tiny ">Office</div>
            ...
            <!-- form-add-product -->
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('user.offproduct.store')}}">
              @csrf
                ...
                <div class="wg-box">
                  @if(Session::has('status'))
                    ...
                    <fieldset class="name">
                        <div class="body-title mb-10">Office name <span class="tf-color-1">*</span>
                        </div>
                        ...
                        <div class="text-tiny">Do not exceed 100 characters when entering the Office name.</div>
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter user name" name="username" tabindex="0" value="{{old('username')}}" aria-required="true" required="">
        ...
        <select class="" name="featured">
            ...
            <option value="1">Yes</option>
                    ...
                    <div class="wg-box">
                      ...
                      <input type="radio" id="myRadio1" name="Wkstnsdesks" value="Workstations/Desks"><span class="body-title mb-10">Workstations/Desks</span><br/>
                      <input type="radio" id="myRadio2" name="Mtingrooms" value="Meeting Rooms"><span class="body-title mb-10">Meeting Rooms</span><br/>
                      <input type="radio" id="myRadio3" name="rceptnarea" value="Reception Area"><span class="body-title mb-10">Reception Area<br/>
                      <input type="radio" id="myRadio4" name="privateoffices" value="Private Offices"><span class="body-title mb-10">Private Offices</span><br/>
                      <input type="radio" id="myRadio5" name="brkroomcafeteria" value="Break Room/Cafeteria"><span class="body-title mb-10">Break Room/Cafeteria</span><br/>
                      <input type="radio" id="myRadio6"  name="strgefilesarea" value="Storage/Files Area"><span class="body-title mb-10">Storage/Files Area<br/>
                      <input type="radio" id="myRadio7" name="opnplanareas" value="Open Plan Areas"><span class="body-title mb-10">Open Plan Areas</span><br/>
                      <input type="radio" id="myRadio8" name="restrooms" value="Restrooms"><span class="body-title mb-10">Restrooms</span><br/>
                      <input type="radio" id="myRadio9" name="intntwkinfrtrture" value="Internet & Network Infrastructure"><span class="body-title mb-10"> Internet & Network Infrastructure</span><br/>
                      <input type="radio" id="myRadio10" name="securitysyst" value="Security Systems"><span class="body-title mb-10">Security Systems</span><br/>
                      <input type="radio" id="myRadio11" name="hvac" value="HVAC"><span class="body-title mb-10">HVAC</span><br/>
                      <input type="radio" id="myRadio12" name="Egnmcfniture" value="Ergonomic Furniture"><span class="body-title mb-10">Ergonomic Furniture</span><br/>
                      <input type="radio" id="myRadio13" name="lighting" value="Lighting"><span class="body-title mb-10">Lighting</span><br/>
                      <input type="radio" id="myRadio14" name="prntcopy" value="Printing/Copy Stations"><span class="body-title mb-10">Printing/Copy Stations</span><br/>
