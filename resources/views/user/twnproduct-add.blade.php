...
<div class="main-content-inner">
              ...
              <div class="main-content-wrap">
                                ...
                                <!-- form-add-product -->
                                <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('user.twnproduct.store')}}">
                                  @csrf
                                    ...
                                    <div class="wg-box">
                                      @if(Session::has('status'))
                                         ...
                                         @endif
                                        <fieldset class="name">
                                            <div class="body-title mb-10">House name <span class="tf-color-1">*</span>
                                            </div>
                                        ...
                                        <fieldset class="description">
                                            ...
                                            <div class="text-tiny">Your full description.</div>
                                        </fieldset>
