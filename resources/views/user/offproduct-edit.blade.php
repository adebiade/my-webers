...
<div class="main-content-inner">
    ...
    <div class="text-tiny ">Office</div>
            ...
            <!-- form-add-product -->
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('user.offproduct.update')}}">
                @csrf
                @method('PUT')
           ...
           <div class="wg-box">
             @if(Session::has('status'))
               ...
               <div class="text-tiny">Do not exceed 100 characters when entering the address name.</div>
