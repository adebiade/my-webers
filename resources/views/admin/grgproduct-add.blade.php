...
<div class="main-content-inner">
              ...
              <div class="main-content-wrap">
                                ...
                                <!-- form-add-product -->
                                <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.grgproduct.store')}}">
                                  @csrf
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <div class="text-tiny">The same username as your user account username.</div>
                                        </fieldset>
