                                ...
                                <img src="images/upload/upload-1.png" alt="">
                                        ...
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                <div class="body-title mb-10">Regular Price <span
                                                        class="tf-color-1">*</span></div>
                                                <input class="mb-10" type="text" placeholder="Enter regular price" name="regular_price" tabindex="0" value="{{('regular_price')}}" aria-required="true"
                                                    required="">
                                            </fieldset>
                                            ...
                                            <fieldset class="name">
                                                <div class="body-title mb-10">Sale Price <span
                                                        class="tf-color-1">*</span></div>
                                                <input class="mb-10" type="text" placeholder="Enter sale price" name="sale_price" tabindex="0" value="{{('sale_price')}}" aria-required="true"
                                                    required="">
                                            </fieldset>
                                        ...
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="Enter SKU" name="SKU"tabindex="0" value="{{('SKU')}}" aria-required="true" required="">
                                            </fieldset>
                                            ...
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="Enter quantity"name="quantity" tabindex="0" value="{{('quantity')}}" aria-required="true"
                                                    required="">
                                            </fieldset>
