...
<div class="main-content-inner">
              ...
              <div class="main-content-wrap">
                                ...
                                <!-- form-add-product -->
                                <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.vlproduct.store')}}">
                                  @csrf
                                    ...
                                    <div class="wg-box">
                                      @if(Session::has('status'))
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <div class="text-tiny">The same user name as your account username.</div>
                                        </fieldset>
                                        ...
                                        <fieldset class="shortdescription">
                                            ...
                                            <div class="text-tiny">Enter your short description.</div>
                                        </fieldset>
