...
<div class="main-content-inner">
  ...
  <!-- form-add-product -->
  <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.agentform.update')}}">
    @csrf
    @method('PUT')
     <input type="hidden" name="id" value="{{$agentform->id}}" />
      <div class="wg-box">
        ...
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" placeholder="Enter your twitter account"
                name="fcbk" tabindex="0" value="{{$agentform->instgrm}}" aria-required="true" required="">
