    ...
    <section class="product-single container">
      <div class="row">
        <div class="col-lg-7">
          <div class="product-single__media" data-media-type="vertical-thumbnail">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('uploads/arpproducts')}}/{{$aproduct->image}}" width="900"
                      height="900" alt="{{$aproduct->name}}" />
                    <a data-fancybox="gallery" href="{{asset('uploads/arpproducts')}}/{{$aproduct->image}}" data-bs-toggle="tooltip"
                  ...
                  @foreach (explode(',',$aproduct->images) as $gimg)

                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('uploads/arpproducts')}}/{{$gimg}}" width="900"
                      height="900" alt="" />
                    <a data-fancybox="gallery" href="{{asset('uploads/arpproducts')}}/{{$gimg}}" data-bs-toggle="tooltip"
                      data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_zoom" />
                      </svg>
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"src="{{asset('uploads/arpproducts/thumbnails')}}/{{$aproduct->image}}" width="104" height="104" alt="" /></div>

                  @foreach (explode(',',$aproduct->images) as $gimg)

                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset('uploads/arpproducts/thumbnails')}}/{{$gimg}}" width="104" height="104" alt="" /></div>
                  @endforeach
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-5">
          ...
          <h1 class="product-single__name">{{$aproduct->name}}</h1>
          ...
          <div class="product-single__price">
            <span class="current-price">${{$aproduct->sale_price}}</span>
          </div>
          ...
          <form name="addtocart-form" method="post">
            ...
            <!--  <div class="qty-control position-relative">
              ...
              <button type="submit" class="btn btn-primary btn-addtocart js-open-aside" data-aside="cartDrawer" style="font-size:18px;">{{$aproduct->mobile}}</button>
            </div>
          </form>
          ...
          <div class="product-single__meta-info">
            <div class="meta-item">
              ...
              <span style="font-size:12px;">{{$aproduct->SKU}}</span>
            </div>
            <div class="meta-item">
              <label style="font-size:12px;">Categories:</label>
              <span style="font-size:12px;">{{$aproduct->category->name}}</span>
            </div>
            <div class="meta-item" style="font-size:12px;">
              <label>Address:</label>
              <span><b>{{$aproduct->address}}</b></span>
            </div>
      ...
      <div class="product-single__details-tab">
        ...
        <div class="tab-content">
          <div class="tab-pane fade show active" id="tab-description" role="tabpanel"
            ...
            <div class="product-single__description text-break" style="font-size:13px;">
              <blockquote class="blockquote text-cent">
              <p class="mb-0">{{$aproduct->description}}</p>
            </blockquote>
            </div>
          </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="{{route('inquiry.aproduct.details',['aproduct_slug'=>$rproduct->slug])}}">
                  <img loading="lazy" src="{{asset('uploads/arpproducts')}}/{{$rproduct->image}}" width="330" height="400" alt="{{$rproduct->name}}" class="pc__img">

                 @foreach(explode(",",$aproduct->images) as $gimgs)
               <img loading="lazy" src="{{asset('uploads/arpproducts')}}/{{$gimg}}" width="330" height="400" alt="{{$rproduct->name}}" class="pc__img pc__img-second"></a>
                @endforeach
                <button
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route('inquiry.aproduct.details',['aproduct_slug'=>$rproduct->slug])}}">{{$rproduct->name}}</a></h6>
                <div class="product-card__price d-flex">
                  <span class="money price">{{$rproduct->sale_price}}</span>
                </div>
