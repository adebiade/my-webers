          ...
          <div class="register-form">
            <form method="POST" action="{{route('register')}}" name="register-form" class="needs-validation" novalidate="">
              ...
              <div class="form-floating mb-3">
                ...
                <div class="pb-3"></div>
                <div class="form-floating mb-3">
                <input class="form-control form-control_gray @error('username') is-invalid @enderror" name="username" value="{{old('username')}}" required="" autocomplete="username"autofocus="">
