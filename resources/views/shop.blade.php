        ...
        <div class="accordion" id="categories-list">
          <div class="accordion-item mb-4 pb-3">
            ...
            <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
              aria-labelledby="accordion-heading-1" data-bs-parent="#category-list">
              <div class="accordion-body px-0 pb-0 pt-3 category-list">
                <ul class="list list-inline mb-0">
                  ...
                  <li class="list-item">
                    ...
                    <span class="test-right float-end">{{$category->products->count()}}</span>
                  </li>
                     @endforeach
              ...
              <div class="search-field multi-select accordion-body px-0 pb-0">
                <ul class="list list-inline mb-0 brand-list">
                  ...
                  <li class="list-item">
                       ...
                       <span class="test-right float-end">
...
<form id="frmfilter" metod="GET" action="{{route('shop.index')}}">
  <input type="hidden" name="page" value="{{$products->currentPage()}}">
  <input type="hidden" name="size" id="size" value="{{$size}}"/>
  <input type="hidden" name="order" id="order" value="{{$order}}"/>
  <input type="hidden" name="brands" id="hdnbrands" />
  <input type="hidden" name="categories" id="hndcategories" />
