...
<head>
    ...
    <title>{{ config('app.name', 'Progress') }}</title>

    <title>Latest wears, hot stocks</title>
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="author" content="progressthreshold media" />
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('css/sweetalert2.css')}}">
                ...
                <div class="section-content-right">
                            ...
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{asset('images/logo/logo.png')}}"
                                        data-light="images/logo/logo.png" data-dark="{{asset('images/logo/logo.png')}}"
                                ...
                                <form class="form-search flex-grow">
                                    <fieldset class="name">
                                        <input type="text" id="searchs-input" placeholder="Search here..." class="show-search" name="name"
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 ProgressThreshold</div>
                        </div>
                    </div>
   ...
   $(function(){
      $("#searchs-input").on("keyup",function(){
